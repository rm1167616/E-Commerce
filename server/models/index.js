...
Store.hasMany(ProductAttribute, { foreignKey: 'store_id', onDelete: 'CASCADE' });
...
Category.belongsTo(Category, { foreignKey: 'parent_category_id', as: 'ParentCategory', onDelete: 'SET NULL' });
...
Product.hasMany(ProductAttributeValue, { foreignKey: 'product_id', onDelete: 'CASCADE' });
Product.hasMany(ProductOffer, { foreignKey: 'product_id', onDelete: 'CASCADE' });
...
ProductAttribute.belongsTo(Store, { foreignKey: 'store_id', onDelete: 'CASCADE' });
ProductAttribute.hasMany(AttributeOption, { foreignKey: 'attribute_id', onDelete: 'CASCADE' });
ProductAttribute.hasMany(ProductAttributeValue, { foreignKey: 'attribute_id', onDelete: 'CASCADE' });

// AttributeOption associations
AttributeOption.belongsTo(ProductAttribute, { foreignKey: 'attribute_id', onDelete: 'CASCADE' });
AttributeOption.hasMany(ProductAttributeValue, { foreignKey: 'option_id', onDelete: 'CASCADE' });

// ProductAttributeValue associations
ProductAttributeValue.belongsTo(Product, { foreignKey: 'product_id', onDelete: 'CASCADE' });
ProductAttributeValue.belongsTo(ProductAttribute, { foreignKey: 'attribute_id', onDelete: 'CASCADE' });
ProductAttributeValue.belongsTo(AttributeOption, { foreignKey: 'option_id', onDelete: 'CASCADE' });
...
ProductOffer.belongsTo(Product, { foreignKey: 'product_id', onDelete: 'CASCADE' });
...
UserProduct.belongsTo(Product, { foreignKey: 'product_id', onDelete: 'CASCADE' });
